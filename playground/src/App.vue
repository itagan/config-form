...
const pageTitle = computed(() => activeExample.value?.title || '示例中心')
    ...
    <section class="playground-workspace">
      <header class="workspace-header">
        <div class="workspace-title">
          ...
          <div>
            <span>ConfigForm Playground</span>
...
body { margin: 0; color: #303133; background: #f5f7fa; font-family: Inter, "PingFang SC", sans-serif; }

.demo-page { max-width: 1080px; margin: 0 auto; }
.demo-page header { margin-bottom: 20px; }
.demo-page h1 { margin: 8px 0 0; }
.demo-page header p { margin: 8px 0 0; color: #6b7280; }
.back-link { color: #409eff; font-size: 13px; text-decoration: none; }
.back-link:hover { text-decoration: underline; }
.demo-card { padding: 24px; background: #fff; border: 1px solid #ebeef5; border-radius: 8px; }
.demo-actions { padding-left: 96px; }
</style>
